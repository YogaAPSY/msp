<?php
  ...
  if (isset($_POST['update'])) {
     $ins_sql = "UPDATE data_mahasiswa SET Points = '$_POST[Point]' , Role = '$_POST[Roles]' WHERE Nim = '$_POST[update_points]'";
...
<div class="col-lg-6">
      <form class="form-horizontal" action="update_point.php" method="post">
       ...
       $sql = mysqli_query($koneksi,"SELECT * FROM data_mahasiswa WHERE Nim = '$_GET[nim]'") or die (mysqli_error());
        ...
        <label for="title">Update Point</label>
        <input type="text" id="title" name="Point" class="form-control" value="<?php echo $row['Points']; ?>">
      </div>
